...
class OTRec(GeneralRecommender):
    def __init__(self, config, dataset):
        ...
        self.bias_1 = nn.Embedding(self.embedding_dim, self.embedding_dim)
        self.bias_2 = nn.Embedding(self.embedding_dim, self.embedding_dim)
        self.bias_3 = nn.Embedding(self.embedding_dim, self.embedding_dim)
    ...
    def InfoNCE(self, view1, view2, temperature):
        ...
        enhanced_pos_score = (view1 * view2).sum(dim=-1) + 0.1*dot_products_tensor.mean(dim=1)  
